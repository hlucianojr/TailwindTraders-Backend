...
using Tailwind.Traders.Rewards.Registration.Api2.Mappers;
using Tailwind.Traders.Rewards.Registration.Api2.Models;

namespace Tailwind.Traders.Rewards.Registration.Api2.Repositories
{
    public class CustomerRepository : BaseRepository
    {
        private readonly CustomerMapper _mapper;
        public CustomerRepository() : base(System.Configuration.ConfigurationManager.ConnectionStrings["dbContext"].ConnectionString)
        {
